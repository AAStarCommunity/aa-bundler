// Package useropV06 Package userop provides the base transaction object used throughout the stackup-bundler.
package useropV06
...
// UserOperation represents an EIP-4337 style transaction for a smart contract account. (V0.6)
...
func (op *UserOperation) Pack() []byte {
	args := abi.Arguments{
		{Name: "BasisUserOperation", Type: UserOpType},
	}
...
// ToMap returns the current BasisUserOperation struct as a map type.
